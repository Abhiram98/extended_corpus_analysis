...
if __name__ == '__main__':
    ...
    tolerance_pct = 3
    top_n_candidates = 5
    data_file = "/Users/malindamacstudio/Documents/Reseach_Extract_Method/Files/Refacorings/Indexed/apache_datasketches-java.json"
    analyse_data(projects_root_dir, project_name,
                 data_file, jextract_out_dir,
                 tolerance_pct, top_n_candidates)
